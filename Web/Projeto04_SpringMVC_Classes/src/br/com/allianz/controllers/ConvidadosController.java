...
public class ConvidadosController {
	...
	public String incluir(ModelMap model) {		
		...
		try {					
			...
			return "convidados/incluirConvidado";
	...
	public ModelAndView listar(
			@RequestParam(value="idEvento", required=false) 
				Integer codigo) {
	...
	public String listarConvidados(@RequestParam("idEvento") int id, ModelMap model) {
		
		try {
			
			model.addAttribute("eventos", eventosDao.listar());	
			
			model.addAttribute("lista_convidados", convidadosDao.listar(id));
			
			return "convidados/listarConvidado";
	...
	@RequestMapping(
			value="/listaAjaxResult/{idEvento}",
